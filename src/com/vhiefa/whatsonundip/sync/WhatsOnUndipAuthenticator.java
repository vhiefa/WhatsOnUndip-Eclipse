...
/**
 * Manages "Authentication" to WhatsOnUndip's backend service.  The SyncAdapter framework
 ...
 */
public class WhatsOnUndipAuthenticator extends AbstractAccountAuthenticator {

    public WhatsOnUndipAuthenticator(Context context) {
        super(context);
    }
